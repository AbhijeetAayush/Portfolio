...
import Project4 from "./assets/pubg.jpeg";
    ...
    <div className="max-w-4xl m-auto relative">
      <header className={`${scrolling ? 'border-b border-gray-900' : ''}  fixed left-0 right-0 top-0 z-20`} id="home">
        <div className="container m-auto px-4 py-6 max-w-4xl bg-black">
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center">
            <div>
              <h1 className="font-bold text-2xl">Abhijeet's Portfolio</h1>
            </div>
            <div>
      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Abhijeet,</h2>
              <div>
                <h2 className="font-bold text-[1.8rem] mt-1 gradiant-text">Fullstack & Data Analyst</h2>
              </div>
              <div>
                <p className="mt-4 text-gray-400">
                Versatile full stack developer adept in MERN stack, with strong analytical skills and expertise in SQL, Python, and data visualization for effective data analysis.
                </p>
                <a href="Abhijeet Resume.pdf" download="Abhijeet Resume.pdf">
          ...
          <div className="container m-auto px-4 sm:py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                Full stack blog web app built using MERN stack with user authentication.
                (HTML,ReactJs,TailwindCSS)
                </p>
                <div className="flex mt-12 gap-2">
                  <button className="flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700">
                    <a href="https://writing-kida.vercel.app/">Live preview</a>
                  </button>
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <div className="flex gap-2 mt-12">
                  ...
                  <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500" >
                    <a href="https://github.com/AbhijeetAayush/Heart-failure-prediction"> Checkout github </a>
                  </button>
                </div>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row  gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <div className="flex gap-4 mt-12">
                  ...
                  <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500">
                    <a href="https://github.com/AbhijeetAayush/Super-Store-Sales-Analysis"> Checkout github</a>
                  </button>
                </div>
              </div>
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  System predicts win or loss on monitoring your data.It predicts the position of enemy.
                  Technologies used are(Python,Excel,Numpy,Pandas,Sklearn,Matplotlib).
                </p>
                <div className="flex gap-2 mt-12">
                  
                  <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500">
                    <a href="https://github.com/AbhijeetAayush/Pubg-Game-prediction">Checkout github</a>
                  </button>
                </div>
              </div>
            </div>
        ...
        <section className="py-10" id="technologies">
          <div className="container m-auto px-4">
            ...
            <div className="mt-14">
              ...
              <div className="mt-8">
                <div className="flex justify-between items-center">
                  <h2 className="font-semibold">CSS, Sass & Bootstrap,TailwindCSS</h2>
                  <p className="text-gray-500">Intermediate</p>
                </div>
                <span className="w-full h-2 mt-2 bg-gradient-to-t from-blue-500 to-cyan-500 block rounded-md" />
              </div>
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
              ...
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                ...
                <p>
                  Underwent through a course on Fullstack Devlopment.Learned technologies like tailwind,React,NodeJS,Figma.Upgraded my skills in fronntend as well as backend.
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
      ...
      <div className="container border border-gray-500 items-center  md:ml-[0rem]   ">
        <div className="contact-form">
          <form
            action="https://formspree.io/f/xnqeobdq"
            method="POST"
